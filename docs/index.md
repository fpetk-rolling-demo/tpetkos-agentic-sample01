...
!!! info
    ...
    **Source Code Repository:** [https://github.com/fpetk-rolling-demo/tpetkos-agentic-sample01](https://github.com/fpetk-rolling-demo/tpetkos-agentic-sample01)

    **GitOps Repository:** [https://github.com/fpetk-rolling-demo/tpetkos-agentic-sample01-gitops](https://github.com/fpetk-rolling-demo/tpetkos-agentic-sample01-gitops)
...
To access the tpetkos-agentic-sample application that was deployed using the Software Template, complete the following instructions:
